...
document.addEventListener('DOMContentLoaded', function () {
  var orderButton = document.getElementById('form-submit');
  if (orderButton) {
    orderButton.addEventListener('click', function (e) {
      ...
      const returnDate = document.querySelector('input[name="return"]');
      const tripType = document.querySelector('input[name="trip"]:checked');

      // Check if any required field is empty
      if (!from.value || !to.value || !departure.value || !returnDate.value || !tripType) {
        alert('Please fill in all the fields before booking.');
        return;
      }

      // All good
      alert('Tickets booked successfully and will be mailed to you');
    });
  }
});        
